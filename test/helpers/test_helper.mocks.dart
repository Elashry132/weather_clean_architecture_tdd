...
// in weather_clean_architecture/test/helpers/test_helper.dart.
...
import 'package:weather_clean_architecture/core/error/failure.dart' as _i7;
...
import 'package:weather_clean_architecture/data/models/weather_model.dart'
    as _i3;
import 'package:weather_clean_architecture/domain/entities/weather.dart' as _i8;
...
class MockGetCurrentWeatherUseCase extends _i1.Mock
  ...
  @override
  _i6.Future<_i2.Either<_i7.Failure, _i8.WeatherEntity>> excute(
          String? cityName) =>
      (super.noSuchMethod(
        Invocation.method(
          #excute,
